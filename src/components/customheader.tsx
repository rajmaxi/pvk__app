        ...
        <View paddingB-10 bg-white>
            <View style={{ height: 40, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
                <View flex row paddingL-20 style={{ justifyContent: 'flex-start' }}>
                    ...
                    <Text text60 marginT-5 marginL-5 numberOfLines={1} grey30 style={{ letterSpacing: .8 }} >
                        {props.title}
                    </Text>
                </View>
            ...
            {/* <View>
                {
                    (props.title == '' ? <View ></View> : <Text numberOfLines={2} style={{ paddingLeft: 20, fontSize: 18, }} grey10 marginL-5 marginB-5>{props.title}</Text>)
                }
            </View> */}
