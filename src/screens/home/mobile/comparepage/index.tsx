...
import { SafeAreaView, TouchableOpacity, FlatList, Dimensions, AsyncStorage, Alert } from 'react-native';
...
const comparePage: React.FC<comparepageProps> = (comparepageProps: any) => {
    ...
    const fetchApi = async () => {
        let productId = [] as any, storeValue = [] as any, indexPrint = [] as any;
        comparepageProps.paramsValue.forEach((element: any) => {
